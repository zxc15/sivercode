...
def draw_rad_per(var):
    ...
    #plt.ylim(0,2)
    plt.ylabel('g(Q=%s):sum to g3'%mu, fontsize=14)
...
def draw_fourier_fsi(par, flavor):#par=[par1, parfit]
    ...
    plt.ylabel(nam1+r'f$^{\perp}_{T;q\to %s }$' %nam2, fontsize=20)
...
#draw_all_par_fourier(1)

#flavor=2

draw_rad_per(2.)

#draw_fourier_fsi([par1, par8], 1)
#draw_fourier_fsi([par1, par9], 2)
#draw_fourier_fsi([par1, par9], 3)
#draw_fourier_fsi([par1, par9], -3)
