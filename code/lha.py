...
#lhadata="NNPDF31_nlo_as_0118"
pdf=lhapdf.mkPDF(lhadata,0)
aphas=lhapdf.mkPDF(lhadata,0)

ff_pion=lhapdf.mkPDF("JAM19FF_pion_nlo",0)
ff_kaon=lhapdf.mkPDF("JAM19FF_kaon_nlo",0)
...
def f_1(var):
    ...
    f_1={0:g, 2:u, 1:d, 3:s, 4:c, 5:b, -2:ub, -1:db, -3:sb, -4:cb, -5:bb}
