...
gam1=-6.*CF
gam2=CF**2.*(-3.+4.*pi**2.-48*zeta(3))+CF*CA*(-961./27.-11*pi**2/3.+52.*zeta(3))+CF*Tr*Nf*(260./27.+4.*pi**2./3.)
gam3=CF**3.0*(-29.0-6.0*pi**2.0-16.0*pi**4.0/5.0-136.0*zeta(3)+32.0*pi**2.0/3.0*zeta(3)+480.0*zeta(5))\
...
def v(mu,b):
    v=gam1/Gam0\
    +lha.a_s(mu)*(beta0/12.*lmu(mu,b)**2.-gam1*Gam1/Gam0**2.+(gam2+d_20)/Gam0)
    return v
