...
def fit(var):
    ...
    experiment=['compass2009','compass2015','hermers','JLab2011','JLab2014']#暂不考虑3He为靶的情况
    hadron=['K','pi','p']
    charge=['+','-','0']
    fit=0
    data_number=0
...
def minuit(par):
    ...
    m.errordef=1
    m.fixed['r0','r1','r2','beta_u', 'eps_u','beta_d', 'eps_d','beta_s', 'eps_s', 'beta_ub', 'eps_ub', 'beta_db', 'eps_db', 'beta_sb', 'eps_sb']=True
