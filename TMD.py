...
def fsiver_all(var,par):#共21个参数
	...
	par_cb=[0,0,0,0,0,0]
	#返回质子在不同味道下的siversPDF
	flavor_par={2:par[1]+par[0], 1:par[2]+par[0], 3:par[3]+par[0], 4:par_cb, 5:par_cb, -2:par[4]+par[0], -1:par[5]+par[0], -3:par[6]+par[0], -4:par_cb, -5:par_cb}
	fsiver_all={i:fsiver(var,flavor_par[i]) for i in flavor_par}
	return fsiver_all
...
'''
var=[0.1,1.0,0.1,0.4,'deuteron','p','-']
